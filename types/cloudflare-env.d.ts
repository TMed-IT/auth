/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=.wrangler.external.jsonc --strict-vars=false --env-interface=CloudflareEnv ./types/cloudflare-env.d.ts` (hash: 00d5402881d09e83d8554c9f15eb1f54)
// Runtime types generated with workerd@1.20260918.1 2026-07-20 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_URL" | "AUTH_DEFAULT_REDIRECT_URL" | "SESSION_MAX_AGE" | "AUTH_EMAIL_ALLOW_REGEX" | "NEXTJS_ENV" | "GOOGLE_CLIENT_ID" | "AUTH_TRUSTED_ORIGINS" | "GOOGLE_CLIENT_SECRET" | "ENCRYPTION_SECRET" | "CSRF_SECRET">> {}
}
